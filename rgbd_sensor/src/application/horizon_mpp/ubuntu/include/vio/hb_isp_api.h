...
typedef struct HB_ISP_OTP_AWB_PARAM_S {
	uint16_t RGain;
	uint16_t GrGain;
	uint16_t GbGain;
	uint16_t BGain;
...
typedef struct HB_ISP_OTP_LSC_PARAM_S {
	uint16_t HTParam_r[18*18];
	uint16_t HTParam_g[18*18];
	uint16_t HTParam_b[18*18];
	uint16_t MTParam_r[18*18];
	uint16_t MTParam_g[18*18];
	uint16_t MTParam_b[18*18];
	uint16_t LTParam_r[18*18];
	uint16_t LTParam_g[18*18];
	uint16_t LTParam_b[18*18];
} ISP_OTP_LSC_PARAM_S;

typedef struct HB_ISP_GOLDEN_LSC_PARAM_S {
	uint16_t D65_shading_r[32*32];
	uint16_t D65_shading_g[32*32];
	uint16_t D65_shading_b[32*32];
	uint16_t TL84_shading_r[32*32];
	uint16_t TL84_shading_g[32*32];
	uint16_t TL84_shading_b[32*32];
	uint16_t A_shading_r[32*32];
	uint16_t A_shading_g[32*32];
	uint16_t A_shading_b[32*32];
} ISP_GOLDEN_LSC_PARAM_S;

extern int HB_OtpAfRangeCorrect(uint8_t pipeId, uint32_t inf_pos, uint32_t macro_pos);
extern int HB_OtpLscCorrect(uint8_t pipeId, ISP_OTP_LSC_PARAM_S *c_otp, ISP_OTP_LSC_PARAM_S *g_otp, ISP_GOLDEN_LSC_PARAM_S *g_lsc);
extern int HB_OtpAwbCorrect(uint8_t pipeId, ISP_OTP_AWB_PARAM_S *c_awb, ISP_OTP_AWB_PARAM_S *g_awb);
